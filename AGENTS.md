...
```bash
mvn verify -T 1C                        # full parallel build + tests
mvn verify -pl <module> -am             # module + its transitive deps from root
mvn verify                              # from a module directory
mvn test -Dtest=ClassName               # single test class
mvn test -Dtest=ClassName#methodName    # single test method
mvn verify -DskipTests                  # compile only, skip tests
mvn deploy -T 1C                        # build and publish to GitHub Packages
```
