...
class BGMicroserviceMutexConfigPodViaPropertyTest {
    ...
    void testMicroserviceMutexServiceBean() throws Exception {
        ...
        assertField(consulMicroserviceMutexService, ConsulMicroserviceMutexService.class, "podName", String.class, "test-pod-name");
    }
}
