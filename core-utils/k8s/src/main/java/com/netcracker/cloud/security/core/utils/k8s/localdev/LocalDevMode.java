...
public final class LocalDevMode {
    ...
    public static boolean isEnabled() {
        return DEV_PROFILE.equalsIgnoreCase(System.getProperty(QUARKUS_PROFILE_PROPERTY))
                || DEV_PROFILE.equalsIgnoreCase(System.getProperty(SPRING_PROFILES_ACTIVE_PROPERTY));
    }
}
