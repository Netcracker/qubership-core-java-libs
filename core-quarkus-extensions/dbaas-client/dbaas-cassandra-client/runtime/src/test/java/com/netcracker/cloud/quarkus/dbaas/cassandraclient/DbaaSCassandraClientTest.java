...
class DbaaSCassandraClientTest {
    ...
    <R extends Request> void testExecuteEvictAndRetryOnAllNodesFailedException() {
        ...
        Assertions.assertDoesNotThrow(() -> client.execute((R) null, null),
    ...
    <R extends Request> void testExecuteAllNodesFailedExceptionPropagatesWhenRetryAlsoFails() {
        ...
        when(alwaysFailSession.execute((R) any(), any())).thenThrow(AllNodesFailedException.class);
        ...
        Assertions.assertThrows(AllNodesFailedException.class, () -> client.execute((R) null, null));
    }
