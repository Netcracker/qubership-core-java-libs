...
| quarkus.dbaas.datasource.initial-sql                                 | SQL statement executed on every new connection after it is created. Useful for setting session-level parameters (e.g. `SET search_path TO myschema`).                                                                 | `none. Optional`                                        | since 10.0.2                                    |
...
| quarkus.dbaas.datasources.\<logicalDbName\>.initial-sql                                 | SQL statement executed on every new connection for the datasource with the specified logical DB. Falls back to `quarkus.dbaas.datasource.initial-sql` if not set.                                                    | `none. Optional`                                        | since 10.0.2 |
