...
@Slf4j
public class OutsideK8S implements PortForwardService {
    ...
    public OutsideK8S(KubernetesClient kubernetesClient, boolean fqdn, boolean useFreeLocalPorts) {
        this(kubernetesClient, new ConcurrentHashMap<>(), fqdn, useFreeLocalPorts);
    }

    public OutsideK8S(KubernetesClient kubernetesClient, Map<Endpoint, LocalPortForward> cache,
