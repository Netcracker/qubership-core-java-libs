...
class RestTemplateConfigServerConfigDataLocationResolverTest {
    ...
    @Test
    void testRestTemplateIsUsedWhenM2MManagerIsNotRegistered() {
        ...
        assertInstanceOf(MicroserviceRestTemplate.class, restClient);
    }

    private RestTemplateConfigServerConfigDataLocationResolver resolver(ConfigurableBootstrapContext bootstrapContext) {
        DeferredLogFactory logFactory = mock(DeferredLogFactory.class);
        return new RestTemplateConfigServerConfigDataLocationResolver(logFactory, bootstrapContext);
    }
